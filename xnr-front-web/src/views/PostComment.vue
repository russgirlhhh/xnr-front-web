        ...
        <el-form-item prop="content">
          ...
          <div class="insert-img" v-if="showInsertImg">
            <div class="pre-img" v-if="commentImg">
              ...
              <span
                class="iconfont xnr-icon-remove"
            ...
            >
              <span class="iconfont xnr-icon-picture"></span>
            </el-upload>
          </div>
        </el-form-item>
      </el-form>
...
import {requestPostComment} from './utils/api'
...
const postCommentDo = () => {
  formDataRef.value.validate(async (valid) => {
    ...
    let result = await requestPostComment(params);
    if (!result) {
      return;
    }
